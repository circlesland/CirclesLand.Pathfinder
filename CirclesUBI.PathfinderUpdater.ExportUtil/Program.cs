...
public static class Program
{
        ...
        string version)
    {
        ...
        foreach (var (_, value) in u.OrgAddressIndexes.OrderBy(o => o.Value))
        {
            ...
            // Console.WriteLine($" * {value} is org");
        }
        ...
        foreach (var trustEdge in trustReader)
        {
            ...
            // Console.WriteLine($" * {trustEdge.UserAddress} -> {trustEdge.CanSendToAddress} ({trustEdge.Limit})");
        }

        trustsFile.Position = 0;
        trustsFile.Write(BitConverter.GetBytes(BinaryPrimitives.ReverseEndianness(edgeCounter)));
        // Console.WriteLine($"Wrote {edgeCounter} trust edges");
        ...
        foreach (var balance in balanceReader)
        {
            ...
            // Console.WriteLine($" * {balance.UserAddress};{balance.TokenAddress};{balance.Value}");
        }
